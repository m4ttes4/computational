...
data2 = pd.read_csv(r'C:\Users\matte\Desktop\computational\progetto1\troppo.dat',header=None,sep='\s+', 
comment='#')
...
ax.plot(data2[0], data2[1], color='green', label='25 Gyr', linestyle='-.')
